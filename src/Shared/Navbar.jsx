      ...
      <div className="navbar md:px-10  lg:px-28">
        <div className="navbar-start ">
          <div className="dropdown">
            ...
            <li className='px-2 text-xl '><a href=""><NavLink className={({ isActive }) => isActive ? "text-[#07332F] border-b-2 border-slate-50  " : "text-[#07332F]"} to="/">Home</NavLink></a></li>
    <li className='px-2 text-xl'><a href=""><NavLink className={({ isActive }) => isActive ? "text-[#07332F]  border-b-2 border-slate-50 " : "text-[#07332F]"} to="/allinstractor">Instractor</NavLink></a></li>
    <li className='px-2 text-xl'><a href=""><NavLink className={({ isActive }) => isActive ? "text-[#07332F] border-b-2 border-slate-50  " : "text-[#07332F]"} to="/classes">Classes</NavLink></a></li>
        ...
        <div className="navbar-center hidden lg:flex">
          ...
          <li className='px-2 text-xl '><a href=""><NavLink className={({ isActive }) => isActive ? "text-white border-b-2 border-slate-50  " : "text-slate-50"} to="/">Home</NavLink></a></li>
